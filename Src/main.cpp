...
static void prepareApp()
{
	...
	QCoreApplication::setApplicationName("FAT-Client");
}
...
int main(int argc, char** argv)
{
	...
	QString fatClientPath = FatClientPath;
	QString transDir = fatClientPath + "Trans/";
	...
	QString qmlPath = fatClientPath + "Qml/";
	QString imgPath = fatClientPath + "Image/";
	QString contentsPath = fatClientPath + "Contents/";
